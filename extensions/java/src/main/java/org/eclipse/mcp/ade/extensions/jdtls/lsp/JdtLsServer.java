 ...
 *******************************************************************************/
package org.eclipse.mcp.ade.extensions.jdtls.lsp;

import org.eclipse.mcp.ade.ContributionManager;
import org.eclipse.mcp.ade.extensions.jdtls.build.BuildSupportManager;
import org.eclipse.mcp.ade.extensions.jdtls.build.ServerStatusProgressMonitor;
import org.eclipse.mcp.ade.server.ServerStatus;
import org.eclipse.mcp.ade.extensions.jdtls.tools.JdtlsCommands;
import org.eclipse.mcp.ade.installer.InstallerEvent;
    ...
    private List<Diagnostic> parseDiagnosticsResult(Object result) {
        if (result instanceof List<?> list) {
            return list.stream()
                    .map(item -> {
                        try {
                            var pdp = JsonUtils.toModel(item, PublishDiagnosticsParams.class);
