...
public class RangeFormattingCapabilityRegistry extends TextDocumentServerCapabilityRegistry<DocumentRangeFormattingRegistrationOptions> {
    ...
    public RangeFormattingCapabilityRegistry(LspClientFeatures clientFeatures) {
        super(clientFeatures);
    }

    static class ExtendedDocumentRangeFormattingRegistrationOptions extends DocumentRangeFormattingRegistrationOptions implements ExtendedDocumentSelector.DocumentFilersProvider {
    ...
    @Override
    protected DocumentRangeFormattingRegistrationOptions create(JsonObject registerOptions) {
        return JsonUtils.getLsp4jGson().fromJson(registerOptions, ExtendedDocumentRangeFormattingRegistrationOptions.class);
    }

    public boolean isRangeFormattingSupported(LanguageDocument document) {
