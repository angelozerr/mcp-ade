...
public class TypeHierarchyCapabilityRegistry extends TextDocumentServerCapabilityRegistry<TypeHierarchyRegistrationOptions> {
    ...
    public TypeHierarchyCapabilityRegistry(LspClientFeatures clientFeatures) {
        super(clientFeatures, sc -> hasCapability(sc.getTypeHierarchyProvider()), TypeHierarchyRegistrationOptions.class);
    }

    public boolean isTypeHierarchySupported(LanguageDocument document) {
